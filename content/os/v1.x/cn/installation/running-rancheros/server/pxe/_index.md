...
| url | url |  |
| vmware** |  | set `guestinfo` cloud-init or interface data as per [VMware ESXi]({{< baseurl >}}/os/v1.x/cn/installation/running-rancheros/cloud/vmware-esxi) |
...
When booting via iPXE, RancherOS can be configured using a [cloud-config file]({{< baseurl >}}/os/v1.x/cn/installation/configuration/#cloud-config).
