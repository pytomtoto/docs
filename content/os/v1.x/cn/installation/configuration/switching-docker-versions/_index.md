...
The version of User Docker used in RancherOS can be configured using a [cloud-config]({{< baseurl >}}/os/v1.x/cn/installation/configuration/#cloud-config) file or by using the `ros engine` command.
