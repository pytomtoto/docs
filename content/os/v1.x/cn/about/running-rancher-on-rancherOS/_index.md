...
You can easily add hosts into Rancher by using [cloud-config]({{< baseurl >}}/os/v1.x/cn/installation/configuration/#cloud-config) to launch the rancher/agent container.
