...
Besides the [network plug-in]({{< baseurl >}}/rke/v0.1.x/cn/config-options/network-plugins/) and [ingress controllers]({{< baseurl >}}/rke/v0.1.x/cn/config-options/ingress-controllers/), you can define any add-on that you want deployed after the Kubernetes cluster is deployed.
