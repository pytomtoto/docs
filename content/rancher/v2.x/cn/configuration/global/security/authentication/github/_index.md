...
>**先决条件:** Read [External Authentication Configuration and Principal Users]({{< baseurl >}}/rancher/v2.x/cn/concepts/global-configuration/authentication/#external-authentication-configuration-and-principal-users).
