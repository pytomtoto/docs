...
* [添加自定义主机](/docs/rancher/v1.x/cn/infrastructure/hosts/custom/)
* [添加 AWS EC2 主机](/docs/rancher/v1.x/cn/infrastructure/hosts/amazon/)
* [添加 Azure 主机](/docs/rancher/v1.x/cn/infrastructure/hosts/azure/)
* [添加 DigitalOcean 主机](/docs/rancher/v1.x/cn/infrastructure/hosts/digitalocean/)
* [添加 Exoscale 主机](/docs/rancher/v1.x/cn/infrastructure/hosts/exoscale/)
* [添加 Packet 主机](/docs/rancher/v1.x/cn/infrastructure/hosts/packet/)
* [添加 Rackspace 主机](/docs/rancher/v1.x/cn/infrastructure/hosts/rackspace/)
* [添加其他云提供商的主机](/docs/rancher/v1.x/cn/infrastructure/hosts/other/)
...
如果当前的环境是在代理之后，要给Rancher添加主机，需要修改这台主机的Docker deamon指向代理。相关的细节可以浏览[本文](/docs/rancher/v1.x/cn/infrastructure/hosts/custom/#添加代理服务器之后的主机)，在此不在累述。
